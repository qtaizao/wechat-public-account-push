...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'I5SO1uzbBpyrgKRu8fwWVQ3YIp8dF8qu5JQGqwflbaw',
      ...
      festivals: [
        ...
        {
          type: '节日', name: '相识纪念日', year: '2022', date: '09-08',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
  ...
  CALLBACK_TEMPLATE_ID: 'I5SO1uzbBpyrgKRu8fwWVQ3YIp8dF8qu5JQGqwflbaw',
